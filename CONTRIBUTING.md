...
### Report issues
Check project and report your issue [here](https://github.com/NazarkinRoman/tinylink/issues)    
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/tinylink.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/NazarkinRoman/tinylink.git`).
